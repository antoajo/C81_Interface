! This program is for creating c81 file for airfoil with more than one mach number data available
! The program reads the .csv file and writes it to .C81 
! The csv input files must have the following format--> AoA,Cl,AoA,Cd,AoA,Cm
! an output file .C81 is created in the Airfoil_data/ directory.

program c81_builder_allmach
  ...
  integer, parameter :: nMach = 10 ! specify the 
  integer :: i,j
  ...
  ! Specify the mach numbers available
...
end program c81_builder_allmach
